...
while (flag)
{
    ...
    for (var i = 0; i < questions.Count; i++)
    {
        ...
        {
            if (indexes[j] != randomQuestionIndex) continue;
        ...
        var userAnswer = UserResultStorage.GetNumber(Console.ReadLine());
...
static void AddNewQuestion()
{
    ...
    var answerToAdd = UserResultStorage.GetNumber(Console.ReadLine());
...
void RemoveQuestion()
{
    ...
    var removeQuestionNumber = UserResultStorage.GetNumber(Console.ReadLine());
    while (removeQuestionNumber < 1 || removeQuestionNumber > questions.Count)
    {
        Console.WriteLine("Введите число от 1 до  " + questions.Count);
        removeQuestionNumber = UserResultStorage.GetNumber(Console.ReadLine());
    }
